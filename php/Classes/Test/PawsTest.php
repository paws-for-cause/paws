...
// grab the encrypted properties file
    ...
    **/
   abstract class PawsTest extends TestCase {
      use TestCaseTrait;
      ...
      public final function getDataSet(): QueryDataSet {
         ...
         $dataset->addTable("user", "SELECT userId, userActivationToken, userAge, userEmail, userFirstName, userHash, userLastname, userPhone FROM `user`");
         $dataset->addTable("shelter");
         ...
         $dataset->addTable("like", "SELECT likeAnimalId, likeUserId, likeApproved FROM `like`");
         return ($dataset);
      }
      ...
      public final function getConnection(): Connection {
         ...
         if($this->connection === null) {
            ...
            $secrets = new \Secrets("/etc/apache2/capstone-mysql/Secrets.ini");
