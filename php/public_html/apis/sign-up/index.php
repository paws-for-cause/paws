...
/*
         ...
         $user = new User(generateUuidV4(), $userActivationToken, $requestObject->userAge, $requestObject->userEmail, $requestObject->userFirstName, $hash, $requestObject->userLastName, $requestObject->userPhone);
      ...
      <p>In order to start viewing animals you must confirm your account </p>
